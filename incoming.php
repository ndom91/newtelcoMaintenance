...
<body>
  <!-- Always shows a header, even in smaller screens. -->
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header ">
                                      ...
                                      <div class="mailcHR">NT</div>
                                        <div class="mailWrapper0">
                                          <div class="mdl-textfield mdl-js-textfield mailWrapper1">
                                            <div contenteditable="true" class="mdl-textfield__input mailWrapper2" type="text" rows= "1" id="sample5" >' . $FOUND_BODY . '</div>
                                          </div>
                                        </div>
      ...
      <!-- Overlay Scrollbars -->
      <link rel="preload stylesheet" as="style" type="text/css" href="assets/css/OverlayScrollbars.css" onload="this.rel='stylesheet'">
</body>
</html>
